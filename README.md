...
To enable the Darwin Core Data Package, new terms will have to be added. These include new classes and new properties in those classes. New classes are described below; for now, to explore new properties, see the table schemas. We are working on creating a provisional version of a Darwin Core Quick Reference Guide that includes all of classes and properties as they are defined in the DwC-DP.
