...
<table class="c12">
  ...
  <tr class="c4">
    <td class="c6" colspan="1" rowspan="1">
      <p class="c2">
        <span class="c1">General data structure</span>
      </p>
    </td>
    <td class="c7" colspan="1" rowspan="1">
      <p class="c9">
        <span class="c1">&ldquo;Star schema&rdquo;, with a &ldquo;Core&rdquo; (Event, Occurrence, Taxon) file and other data files shared through &ldquo;Extensions&rdquo; to that Core. Relationships between each extension file and the core file expressed as a primary key in the &quot;Core&quot; and (unique identifiers within a table) and a foreign key in the &quot;Extension&quot;.</span>
      </p>
    </td>
    <td class="c11" colspan="1" rowspan="1">
      <p class="c9">
        <span class="c1">No Cores, no Extensions.</span>
      </p>
      <p class="c9">
        <span class="c1">Tables (files) related in multiple ways (Fig 1).</span>
      </p>
      <p class="c9">
        <span class="c1">Details of the relationships between files are also in the table schemas, expressed as primary keys and foreign keys (fields that contain the identifiers equal to the value of a primary key in another file plus a natural language predicate to describe the relationship).</span>
      </p>
    </td>
  </tr>
  <tr class="c4">
    ...
    <td class="c7" colspan="1" rowspan="1">
      <p class="c9">
        ...
        <td class="c11" colspan="1" rowspan="1">
      <p class="c9"><span class="c1">Structure: datapackage.json</span></p>
      <p class="c9"><span class="c1">Dataset metadata: eml.xml</span></p>
    </td>
  </tr>
  <tr class="c4">
